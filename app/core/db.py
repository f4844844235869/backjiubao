...
DEFAULT_PERMISSION_DEFS = [
    ...
    {"code": "product.category.create", "name": "创建商品分类", "module": "product"},
    {"code": "product.category.update", "name": "更新商品分类", "module": "product"},
    {"code": "product.category.delete", "name": "删除商品分类", "module": "product"},
    {"code": "product.product.read", "name": "查看商品", "module": "product"},
    {"code": "product.product.create", "name": "创建商品", "module": "product"},
    {"code": "product.product.update", "name": "更新商品", "module": "product"},
    {"code": "product.product.delete", "name": "删除商品", "module": "product"},
    {"code": "product.sku.read", "name": "查看 SKU", "module": "product"},
    {"code": "product.sku.create", "name": "创建 SKU", "module": "product"},
    {"code": "product.sku.update", "name": "更新 SKU", "module": "product"},
    {"code": "product.sku.delete", "name": "删除 SKU", "module": "product"},
    {"code": "product.fund_limit.read", "name": "查看资金限制", "module": "product"},
    {"code": "product.fund_limit.create", "name": "创建资金限制", "module": "product"},
    {"code": "product.fund_limit.update", "name": "更新资金限制", "module": "product"},
    {"code": "product.fund_limit.delete", "name": "删除资金限制", "module": "product"},
    {"code": "product.gift_template.read", "name": "查看赠送模板", "module": "product"},
    {"code": "product.gift_template.create", "name": "创建赠送模板", "module": "product"},
    {"code": "product.gift_template.update", "name": "更新赠送模板", "module": "product"},
    {"code": "product.gift_template.delete", "name": "删除赠送模板", "module": "product"},
    # Member Wallet (会员钱包)
    {"code": "wallet.member.read", "name": "查看会员", "module": "wallet"},
    {"code": "wallet.member.create", "name": "创建会员", "module": "wallet"},
    {"code": "wallet.member.update", "name": "更新会员", "module": "wallet"},
    {"code": "wallet.member.delete", "name": "删除会员", "module": "wallet"},
    {"code": "wallet.account.read", "name": "查看钱包账户", "module": "wallet"},
    {"code": "wallet.recharge_plan.read", "name": "查看充值方案", "module": "wallet"},
    {"code": "wallet.recharge_plan.create", "name": "创建充值方案", "module": "wallet"},
    {"code": "wallet.recharge_plan.update", "name": "更新充值方案", "module": "wallet"},
    {"code": "wallet.recharge_plan.delete", "name": "删除充值方案", "module": "wallet"},
    {"code": "wallet.recharge.create", "name": "会员充值", "module": "wallet"},
    {"code": "wallet.transaction.read", "name": "查看钱包流水", "module": "wallet"},
    # POS
    {"code": "pos.order.read", "name": "查看订单", "module": "pos"},
    {"code": "pos.order.create", "name": "创建订单", "module": "pos"},
    {"code": "pos.order.update", "name": "更新订单", "module": "pos"},
    {"code": "pos.order.delete", "name": "删除订单", "module": "pos"},
    {"code": "pos.payment.read", "name": "查看支付记录", "module": "pos"},
    {"code": "pos.payment.create", "name": "创建支付记录", "module": "pos"},
    {"code": "pos.shift.read", "name": "查看交接班", "module": "pos"},
    {"code": "pos.shift.create", "name": "创建交接班", "module": "pos"},
    {"code": "pos.shift.update", "name": "更新交接班", "module": "pos"},
    # Inventory (库存)
    {"code": "inventory.warehouse.read", "name": "查看仓库", "module": "inventory"},
    {"code": "inventory.warehouse.create", "name": "创建仓库", "module": "inventory"},
    {"code": "inventory.warehouse.update", "name": "更新仓库", "module": "inventory"},
    {"code": "inventory.warehouse.delete", "name": "删除仓库", "module": "inventory"},
    {"code": "inventory.balance.read", "name": "查看库存余额", "module": "inventory"},
    {"code": "inventory.transaction.read", "name": "查看库存流水", "module": "inventory"},
    {"code": "inventory.transaction.create", "name": "记录库存变动", "module": "inventory"},
    {"code": "inventory.transfer.read", "name": "查看调拨单", "module": "inventory"},
    {"code": "inventory.transfer.create", "name": "创建调拨单", "module": "inventory"},
    {"code": "inventory.transfer.update", "name": "更新调拨单", "module": "inventory"},
]
